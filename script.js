const schoolProfile = {
  ...
  links: {
    ...
    facebook: "https://www.facebook.com/p/Abc-play-school-100064069693243/",
...
const faqData = [
  ...
  },
  {
    ...
    answer: "Our school currently supports classes from primary level (Class 1) up to the senior secondary level (Class 12)."
  },
  {
...
function getBotReply(question) {
  ...
  if (!bestMatch || bestMatch.score === 0) {
    return { answer: "I do not have that answer yet. Please contact the school office by phone, email, or WhatsApp for more help." };
  }
